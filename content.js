...
window.MS_CONTENT = {
  ...
  gallerySection: {
    ...
    ctaLabel: "Rezervovať",
    images: [
      { src: "brand_assets/Gallery 1.webp", alt: "[Fotografia z výstupu 1]" },
      { src: "brand_assets/Gallery2.webp", alt: "[Fotografia z výstupu 2]" },
      { src: "brand_assets/GALLERY3.webp", alt: "[Fotografia z výstupu 3]" },
      { src: "brand_assets/Gallery4.webp", alt: "[Fotografia z výstupu 4]" },
      { src: "brand_assets/gallery5.webp", alt: "[Fotografia z výstupu 5]" },
      { src: "brand_assets/Gallery6.webp", alt: "[Fotografia z výstupu 6]" },
    ],
  },
